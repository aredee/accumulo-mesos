...
sudo -u hduser sed -i.bak 's=<configuration>=<configuration>\<property>\<name>fs\.default\.name\</name>\<value>hdfs://192.168.50.101:9000\</value>\</property>=g' core-site.xml
